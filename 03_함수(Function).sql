...
SELECT TO_CHAR(1234, 'L999999') FROM DUAL; -- L: 현재 설정된 나라의 화폐 단위 출력
...
SELECT TO_DATE('20201212 222530', 'YYYY-MM-DD HH24MISS') FROM DUAL;
...
-- EMPLOYEE 테이블에서 1998년 1워 1일 이후에 입사한 사원의 사번, 직원명, 입사일
SELECT EMP_ID, 
       EMP_NAME,
       HIRE_DATE
FROM EMPLOYEE
...
/*
    ...
    2) NVL2
        ...
        - 값이 NULL이 아니면 값2를 반환, 값이 NULL이면 값3을 반환한다. 
